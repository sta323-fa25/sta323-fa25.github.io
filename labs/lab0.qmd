...
-   Go to the course organization at [github.com/sta323-fa25](https://github.com/sta323-fa25) organization on GitHub. Click on the repo with the prefix **lab-0**. It contains the starter documents you need to complete the lab.
