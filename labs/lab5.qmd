...
subtitle: "Due Friday, October 17 5:00pm"  
editor: source
execute:
  eval: false
---

> "The root of [the function] is bitter [when unsolvable via Newton-Raphson] but the fruit is sweet"
> -- Aristotle
...
-   In the *terminal* tab, type `cd ~` to navigate to your home directory. Next `git clone git@github.com:sta323-fa25/lab-5-team_name.git` where `team_name` is replaced with your team name (see the excel signup sheet in box or your github).
...
- Next plot the derivative of the log-likelihood from `-5` to `-0.01`. Be sure to appropriately label your plots, add relevant titles, etc. Combine your plots using [`patchwork`](https://sta323-fa25.github.io/slides/lec07.html#/patchwork). 
