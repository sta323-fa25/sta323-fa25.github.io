...
#| message: false
#| eval: false
amendments = read_csv("http://sta323-fa25.github.io/data/American_Amendments.csv")
```

Today's data set comes from [data.gov](https://catalog.data.gov/dataset/amending-america-proposed-amendments-to-the-united-states-constitution-1787-to-2014?utm_source=chatgpt.com)
