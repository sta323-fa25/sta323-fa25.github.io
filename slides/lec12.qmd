...
## Beta-binomial nuisance parameters
...
$$
\hspace{4in} \text{In general, the Jacobian, } J=\left[\begin{array}{ccc}
...
```{r}
download.file("https://sta323-fa25.github.io/scripts/betabinomial.R",
